<?php include_once 'includes/templates/header.php'; ?>
    <section class="contenedor seccion">
        ...
        <form id="registro" class="registro" action="validar_registro.php" method="POST">
            <div id="dato_usuario" class="registro caja clearfix">
                <div class="campo">
            ...
            <div id="resumen" class="resumen">
                ...
                <div class="caja clearfix">
                    <div class="extras">
                        <div class="orden">
                            <label for="camisa_evento">Camisa del evento $10.00 <small>(promoción 7% dto.)</small></label>
                            <input type="number" min="0" id="camisa_evento" name="pedido_camisas" size="3" placeholder="0">
                        </div>
                        <!--Orden-->
                        <div class="orden">
                            <label for="etiquetas">Paquete de 10 etiquetas $2.00<small>(HTML, CSS, JavaScript, Chrome, Node)</small></label>
                        ...
                        <input type="button" id="calcular" class="button" value="Calcular" disabled>
                    </div>
                    <!--Extras-->
                    ...
                    <div class="total">
                        ...
                        <input type="submit" class="button" name="submit" id="btnRegistro" value="Pagar" disabled>
                    </div>
                    <!--Total-->
                </div>
                <!--Caja-->
